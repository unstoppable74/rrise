	...
	)
{
	...
	else
	{
		if ( in_pTransfer )
		{
			...
			this->AddMemView(in_pTransfer, bStoreData);
...
template <class TStmBase>
bool CAkStmDeferredLinedUpBase<TStmBase>::CancelTransfers(
