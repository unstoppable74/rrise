            ...
            if (in_ordered != null)
            {
                foreach (FilePackageGenerator.Context.PackageItem item in in_ordered)
                {
                    ...
                    else if (item.Descriptor != null)
                    {
                        ...
                        AK.Wwise.InfoFile.MediaDescriptorType md;
                        if ((md = item.Descriptor as AK.Wwise.InfoFile.MediaDescriptorType) != null && md.Loose)
                        {
                            fileType = FileType.LooseMedia;
                        }
                        else if ((md = item.Descriptor as AK.Wwise.InfoFile.MediaDescriptorType) != null && md.Streaming)
                        {
