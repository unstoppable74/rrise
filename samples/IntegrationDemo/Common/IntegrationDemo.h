...
private:
	...
	// Callback fired when sound engine assertions fire
	static void IntegrationDemoAssertHook(const char* in_pszExpression, const char* in_pszFileName, int in_lineNumber);
